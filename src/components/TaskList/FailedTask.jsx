...
const CompleteTask = ({data}) => {
  return (
    <div>
       <div className='flex-shrink-0 h-full w-[300px] bg-red-600 rounded-xl p-5'>
                <div className='flex justify-between '>
                    <h2 className='bg-red-500 text-white border-2 border-black px-2 font-semibold rounded-xl'>{data.category}</h2>
                ...
                <button className='bg-green-500 py-1 px-2 text-sm rounded-md text-black font-bold'>Failed</button> 
                </div>
            </div>
    </div>
  )
